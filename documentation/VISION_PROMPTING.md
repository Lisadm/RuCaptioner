...
This document explains how RuCaptioner constructs prompts when sending images to vision language models (VLMs) for automatic caption generation.

## Overview

RuCaptioner uses a **two-part prompt architecture** that separates concerns:
...
RuCaptioner handles various response formats:
...
RuCaptioner's two-part prompt architecture gives you:
...
Whether you're training a character LoRA, building a style dataset, or creating comprehensive image descriptions, RuCaptioner's prompting system adapts to your needs while maintaining reliability.
