"""
RuCaptioner Logging Configuration
...
def setup_logging(level: str = "DEBUG") -> Path:
    ...
    log_file = LOGS_DIR / f"rucaptioner_{SESSION_TIMESTAMP}.log"
    ...
    # Log session start
    logger = logging.getLogger("rucaptioner.startup")
    logger.info("=" * 70)
    logger.info(f"RuCaptioner Session Started")
