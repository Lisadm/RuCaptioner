...
const API = {
     ...
     */
    init(baseUrl = '') {
        // Prioritize explicit baseUrl, then electronAPI backendUrl, then current origin
        if (baseUrl) {
            this.baseUrl = baseUrl;
        } else if (window.electronAPI && window.electronAPI.backendUrl) {
            this.baseUrl = window.electronAPI.backendUrl;
        } else {
